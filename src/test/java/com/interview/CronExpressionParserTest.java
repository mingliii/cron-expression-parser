...
public class CronExpressionParserTest {
    ...
    public void testParse_AllStars() {
        CronExpressionResults results = cronExpressionParser.parse("* * * * * /usr/bin/find");
        assertEquals(
    ...
    public void testParse_WithQuestionMark() {
        CronExpressionResults results = cronExpressionParser.parse("0/15 0 1,15 * ? /usr/bin/find");
        assertEquals(
                "minute         0 15 30 45\n" +
                "hour           0\n" +
                "day of month   1 15\n" +
    ...
    public void testParse() {
        CronExpressionResults results = cronExpressionParser.parse("0/15 0 1,15 * 1-5 /usr/bin/find");
        assertEquals(
                 "minute         0 15 30 45\n" +
                 "hour           0\n" +
                 "day of month   1 15\n" +
